...
<div class="center">
<p style="color: red;">I am making this page into a archived version since my desire is to do more chronological updates (blog posts) than to make very long 'wiki' type pages. Perhaps later I will be able to take all the information that I talk about over time and create a compiled set of pages.</p> </div>
